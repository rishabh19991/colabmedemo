 ...
 */
if ("undefined" == typeof jQuery) throw new Error("Moodboard requires jQuery");
! function(a) {
    "use strict";
    var b = function(c, d) {
    ...
    b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI"], b.COLORS = ["#000000", "#444444", "#666666", "#999999", "#CCCCCC", "#EEEEEE", "#F3F3F3", "#FFFFFF", "#FF0000", "#FF9900", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#9900FF", "#FF00FF", "#F4CCCC", "#FCE5CD", "#FFF2CC", "#D9EAD3", "#D0E0E3", "#CFE2F3", "#D9D2E9", "#EAD1DC", "#EA9999", "#F9CB9C", "#FFE599", "#B6D7A8", "#A2C4C9", "#9FC5E8", "#B4A7D6", "#D5A6BD", "#E06666", "#F6B26B", "#FFD966", "#93C47D", "#76A5AF", "#6FA8DC", "#8E7CC3", "#C27BA0", "#CC0000", "#E69138", "#F1C232", "#6AA84F", "#45818E", "#3D85C6", "#674EA7", "#A64D79", "#990000", "#B45F06", "#BF9000", "#38771D", "#134F5C", "#0B5394", "#351C75", "#741B47", "#660000", "#783F04", "#7F6000", "#274E13", "#0C343D", "#073763", "#201211", "#4C1130"], b.image_commands = {
        ...
        url_regex: /(?:https?:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/(?:watch\?v=|embed\/)?(.+)/g,
        ...
        test_regex: /^.+(screen.yahoo.com)\/(videos-for-you)?\/[^_&]+/,
        url_regex: "",
        url_text: "",
        ...
        allowedImageTypes: ["jpeg", "jpg", "png", "gif", "psd"],
        alwaysBlank: !1,
        alwaysVisible: !1,
        autosave: !1,
        ...
        if (!this.selectionDisabled) {
            ...
            b.length > 0 && a.length > 0 && (this.$element.focus(), this.setSelection(a[0], 0, b[0], 0), this.removeMarkers(), this.editableDisabled || this.isHTML || this.$element.attr("contenteditable", !0), this.$element.focus())
        }
        ...
        this.isImage || this.$element.find("img").each(function(b, c) {
            var d = a(c);
            0 === d.parents(".f-img-wrap").length && (d.parents("a").length > 0 ? a(d.parents("a")[0]).wrap('<span class="f-img-wrap"></span>') : d.wrap('<span class="f-img-wrap"></span>'))
        })
    }, b.prototype.sync = function(a) {
        void 0 == a && (a = !0), a && !this.isResizing() && this.restoreSelectionByMarkers(), this.syncClean(this.$element), this.disableImageResize(), this.isLink || this.isImage || this.$element.trigger("placeholderCheck");
        var b = this.getHTML();
        this.trackHTML !== b && null != this.trackHTML ? (this.callback("contentChanged", [], !1), this.refreshImageList(), this.trackHTML = b) : null == this.trackHTML && (this.trackHTML = b), this.$textarea && this.$textarea.val(b), this.isResizing() || this.isLink || this.isImage || this.$element.focus()
        ...
        this.initElement(a), this.initElementStyle(), this.isImage || this.isLink || (this.initUndoRedo(), this.enableTyping(), this.initShortcuts()), this.initEditor(), this.isLink || this.initDrag(), this.initOptions(), this.initEditorSelection(), this.initAjaxSaver(), this.isLink || !this.isEnabled("insertImage") && !this.isImage || (this.initImageResizer(), this.initImagePopup()), this.initLink(), this.setLanguage(), this.setCustomText(), this.isImage || this.isLink || this.registerPaste(), this.$element.blur()
    }, b.prototype.initLink = function() {
        var b = this,
            c = function(c) {
                c.stopPropagation(), c.preventDefault(), b.link = !0, b.clearSelection(), b.removeMarkers(), b.selectionDisabled || (a(this).before('<span id="marker-true"></span>'), a(this).after('<span id="marker-false"></span>')), b.restoreSelectionByMarkers(), b.exec("createLink");
                var d = a(this).attr("href");
                b.$link_wrapper.find("input.f-lt").val(a(this).text()), b.isLink ? ("#" == d && (d = ""), b.$link_wrapper.find("input.f-lu").val(d), b.$link_wrapper.find(".f-external-link").val(d || "#")) : (b.$link_wrapper.find("input.f-lu").val(d), b.$link_wrapper.find(".f-external-link").val(d)), b.$link_wrapper.find('input[type="checkbox"]').prop("checked", "_blank" == a(this).attr("target")), WYSIWYGModernizr.mq("(max-device-width: 320px) and (-webkit-min-device-pixel-ratio: 2)") ? b.showByCoordinates(a(this).offset().left + a(this).width() / 2, a(this).offset().top + a(this).height()) : b.repositionEditor(!0), b.closeImageMode(), b.showInsertLink()
            };
        this.isLink ? this.$element.on("click touchend", c) : this.$element.on("click touchend", "a", c)
        ...
        document.addEventListener("drop", a.proxy(function() {
            setTimeout(a.proxy(function() {
                b.closeImageMode(), b.hide(), this.sync(), this.clearSelection()
            }, this), 10)
        }, this)), this.$element.on("mousedown", "img", function() {
            b.isResizing() || (b.imageHTML = b.getHTML(), !b.options.imageMove || b.browser.msie ? b.$element.attr("contenteditable", !1) : a(this).parents(".f-img-wrap").removeAttr("contenteditable"), a(this).parents(".f-img-wrap").draggable())
        }), this.$element.on("mouseup", "img", function() {
            b.isResizing() || (b.options.imageMove || b.isImage || b.isHTML || b.$element.attr("contenteditable", !0), a(this).parents(".f-img-wrap").attr("contenteditable", "false"), a(this).parents(".f-img-wrap").draggable('destroy'), a(this).parents('.ui-draggable').draggable.remove())
            ...
            if (!b.isResizing()) {
                ...
                var e = b.imageHandle();
                a(this).parent().find(".f-img-handle").remove(), b.options.imageResize && (a(this).parent().append(e.clone(!0).addClass("f-h-ne")), a(this).parent().append(e.clone(!0).addClass("f-h-se")), a(this).parent().append(e.clone(!0).addClass("f-h-sw")), a(this).parent().append(e.clone(!0).addClass("f-h-nw"))), b.clearSelection(), b.showByCoordinates(a(this).offset().left + a(this).width() / 2, a(this).offset().top + a(this).height()), b.imageMode = !0
            }
        })
    }, b.prototype.initImagePopup = function() {
        this.$image_editor = a('<div class="bttn-wrapper f-image-editor">');
        for (var c in this.options.imageButtons) {
            ...
            if (void 0 !== b.image_commands[d]) {
                ...
                f += void 0 !== this.options.icons[d] ? this.prepareIcon(this.options.icons[d], e.title) : this.prepareIcon(e.icon, e.title), f += "</button>", this.$image_editor.append(f)
            }
        }
        var g = a().append('');
        this.$image_editor.append("").append(g);
        var h = this;
        ...
        if (b.LANGS[this.options.language] && (e = b.LANGS[this.options.language].translation[e]), confirm(e)) {
            if (this.callback("beforeRemoveImage", [a(d)], !1) === !0) {
                {
                    a(d).attr("src")
                }
                c.parents(".f-img-wrap").length ? c.parents(".f-img-wrap").remove() : c.remove(), this.refreshImageList(!0), this.hide(), this.saveUndoStep(), this.callback("afterRemoveImage", [a(d)]), this.focus()
            }
        ...
        if ("TEXTAREA" == b.tagName) this.$textarea = a(b), void 0 !== this.$textarea.attr("placeholder") && "Type something" == this.options.placeholder && (this.options.placeholder = this.$textarea.attr("placeholder")), this.$element = a("<div>").html(this.$textarea.val()), this.$textarea.before(this.$element).hide(), this.$textarea.on("submit", a.proxy(function() {
            ...
            "A" == a(b).parent().tagName && (b = a(b).parent()), this.isImage = !0, this.editableDisabled = !0, this.imageList = [], this.options.buttons = ["insertImage"], this.options.paragraphy = !1, this.options.imageMargin = "auto", a(b).wrap("<div>"), this.$element = a(b).parent(), this.$element.css("display", "inline-block"), this.$element.css("max-width", "100%"), this.$element.css("margin-left", "auto"), this.$element.css("margin-right", "auto"), this.$element.addClass("f-image")
        } else "DIV" != b.tagName && this.options.buttons.indexOf("formatBlock") >= 0 && this.disabledList.push("formatBlock"), this.$element = a(b);
        this.isImage || this.isLink || (this.$box = this.$element, this.$element = a("<div>"), this.setHTML(this.$box.html(), !1), this.$box.html(this.$element).addClass("froala-box"), this.$element.on("keydown", a.proxy(function(b) {
            var c = b.which,
                d = ["PRE", "BLOCKQUOTE"],
        ...
        if (!this.isLink) {
            ...
            var c = [],
                d = this;
            if (this.$element.find("img").each(function(b, e) {
                    var f = a(e);
                    if (c.push(f.attr("src")), "right" == f.css("float")) {
                        var g = f.parent();
                        g.hasClass("f-img-editor") ? (g.css("margin-left", d.options.imageMargin).css("margin-bottom", d.options.imageMargin).css("margin-top", d.options.imageMargin).css("margin-right", "3px"), f.css("margin", "auto")) : f.css("margin-left", d.options.imageMargin).css("margin-bottom", d.options.imageMargin).css("margin-top", d.options.imageMargin).css("margin-right", "3px")
                    } else if ("left" == f.css("float")) {
                        var g = f.parent();
                        g.hasClass("f-img-editor") ? (g.css("margin-right", d.options.imageMargin).css("margin-bottom", d.options.imageMargin).css("margin-top", d.options.imageMargin).css("margin-left", "3px"), f.css("margin", "auto")) : f.css("margin-right", d.options.imageMargin).css("margin-bottom", d.options.imageMargin).css("margin-top", d.options.imageMargin).css("margin-left", "3px")
                    }
                }), void 0 === b)
                for (var e = 0; e < this.imageList.length; e++) c.indexOf(this.imageList[e]) < 0 && this.callback("afterRemoveImage", [this.imageList[e]], !1);
            this.imageList = c
        }
        ...
        var b = [],
            ...
            e = function() {
                ...
                var e = a(b[0]);
                if (1 == b.length && ("marker-false" === e.attr("id") || "marker-true" === e.attr("id") || "" === e.text())) return void(b = []);
                for (var f in b) {
                    var g = a(b[f]);
        ...
        this.$element.css("outline", 0), this.browser.msie || (a += " not-msie"), this.$element.addClass(a)
        ...
        if (!this.isHTML && (this.$element.focus(), "" === this.text())) {
            ...
            if (d.length >= 1 && d[0] != this.$element.get(0))
                for (a in d)
        ...
        this.$editor = a('<div class="froala-editor" style="display: none;">'), a("body").append(this.$editor), this.options.inlineMode ? this.initInlineEditor() : this.initBasicEditor()
        ...
        a(window).on("hide." + this._id, a.proxy(function() {
            ...
            if (!this.isResizing()) {
                var c = this.text();
                "" === c && !this.options.alwaysVisible && (3 != b.which && 2 != b.button || !this.options.inlineMode || this.isImage) || this.isTouch() ? this.options.inlineMode || this.refreshButtons() : (b.stopPropagation(), setTimeout(a.proxy(function() {
                    c = this.text(), "" === c && !this.options.alwaysVisible && (3 != b.which && 2 != b.button || !this.options.inlineMode || this.isImage) || this.isTouch() || this.show(b)
        ...
        }, this)), this.$element.on("mouseup touchend", ".f-img-handle", a.proxy(function(b) {
        ...
        }, this)), this.$image_wrapper && this.$image_wrapper.on("mouseup touchend", a.proxy(function(a) {
            this.isResizing() || a.stopPropagation()
        }, this)), this.$video_wrapper && this.$video_wrapper.on("mouseup touchend", a.proxy(function(a) {
            this.isResizing() || a.stopPropagation()
        }, this)), this.$overlay && this.$overlay.on("mouseup touchend", a.proxy(function(a) {
            this.isResizing() || a.stopPropagation()
        }, this)), this.$image_modal && this.$image_modal.on("mouseup touchend", a.proxy(function(a) {
            this.isResizing() || a.stopPropagation()
        }, this)), a(window).on("mouseup." + this._id, a.proxy(function() {
            this.isResizing() || (this.selectionInEditor() && "" !== this.text() && !this.isTouch() ? this.show(null) : this.$popup_editor.is(":visible") && (this.hide(), this.closeImageMode()))
            ...
            if (!this.isResizing() && this.options.inlineMode && this.selectionInEditor() && this.link !== !0 && this.isTouch()) {
                var b = this.text();
        ...
        return "" === b && 1 == a.find("p, div").length && 1 == a.find("p > br, div > br").length && 0 === a.find("img, iframe, input").length
        ...
        c && (this.options.buttons = c), this.$editor.append('<div class="bttn-wrapper" id="bttn-wrapper-' + this._id + '">'), this.$bttn_wrapper = this.$editor.find("#bttn-wrapper-" + this._id);
        var d, e, f = this,
            g = {
                color: function() {
                    d = f.buildDropdownColor(j), e = f.buildDropdownButton(j, d, "fr-color-picker"), f.$bttn_wrapper.append(e)
                },
                align: function() {
                    d = f.buildDropdownAlign(j), e = f.buildDropdownButton(j, d, "fr-selector"), f.$bttn_wrapper.append(e)
                },
                fontSize: function() {
                    d = f.buildDropdownFontsize(j), e = f.buildDropdownButton(j, d), f.$bttn_wrapper.append(e)
                },
                formatBlock: function() {
                    d = f.buildDropdownFormatBlock(j), e = f.buildDropdownButton(j, d), f.$bttn_wrapper.append(e)
                },
                blockStyle: function() {
                    d = f.buildDropdownBlockStyle(j), e = f.buildDropdownButton(j, d), f.$bttn_wrapper.append(e)
                },
                fontFamily: function() {
                    d = f.buildDropdownFontFamily(), e = f.buildDropdownButton(j, d, "fr-family"), f.$bttn_wrapper.append(e)
                },
                createLink: function() {
                    e = f.buildDefaultButton(j), f.$bttn_wrapper.append(e)
                },
                insertImage: function() {
                    e = f.buildDefaultButton(j), f.$bttn_wrapper.append(e), f.buildInsertImage(), f.options.mediaManager && f.buildMediaManager()
                },
                insertVideo: function() {
                    e = f.buildDefaultButton(j), f.$bttn_wrapper.append(e), f.buildInsertVideo()
                },
                undo: function() {
                    e = f.buildDefaultButton(j), f.$bttn_wrapper.append(e)
                },
                ...
                html: function() {
                    e = f.buildDefaultButton(j), f.$bttn_wrapper.append(e), f.options.inlineMode && f.$box.append(a(e).clone(!0).addClass("html-switch").attr("title", "Hide HTML").click(a.proxy(f.execHTML, f))), f.initHTMLArea()
                }
            };
        for (var h in this.options.buttons) {
            var i = this.options.buttons[h];
            if ("sep" != this.options.buttons[h]) {
                var j = b.commands[i];
                if (void 0 !== j) {
                    j.cmd = i;
                    var k = g[j.cmd];
                    k ? k() : (j.seed ? (d = this.buildDefaultDropdown(j), e = this.buildDropdownButton(j, d)) : e = this.buildDefaultButton(j), this.$bttn_wrapper.append(e))
                } else {
                    if (j = this.options.customButtons[i], void 0 === j) {
                        if (j = this.options.customDropdowns[i], void 0 === j) continue;
                        e = this.buildCustomDropdown(j), this.$bttn_wrapper.append(e);
                        continue
                    }
                    e = this.buildCustomButton(j), this.$bttn_wrapper.append(e)
                }
            } else this.$bttn_wrapper.append(this.options.inlineMode ? '<div class="f-clear"></div><hr/>' : '<span class="f-sep"></span>')
        }
        this.$bttn_wrapper.find('button[data-cmd="undo"], button[data-cmd="redo"]').prop("disabled", !0), this.buildCreateLink(), this.bindButtonEvents()
    }, b.prototype.buildDefaultButton = function(a) {
        var b = '<button class="fr-bttn" title="' + a.title + '" data-cmd="' + a.cmd + '">';
        ...
        var c = a('<button class="fr-bttn" title="' + b.title + '">' + this.prepareIcon(b.icon, b.title) + "</button>");
        ...
        c += '<button class="fr-trigger" title="' + b.title + '">' + this.prepareIcon(b.icon, b.title) + "</button>";
        ...
        var d = '<div class="fr-bttn fr-dropdown ' + c + '" data-name="' + a.cmd + '">',
            e = '<button class="fr-trigger" title="' + a.title + '">' + this.addButtonIcon(a) + "</button>";
        return d += e, d += b, d += "</div>"
    }, b.prototype.buildDropdownColor = function(a) {
        var b = '<div class="fr-dropdown-menu">';
        for (var c in a.seed) {
            var d = a.seed[c],
                e = '<div><p data-text="true">' + d.title + "</p>";
            for (var f in d.value) {
                var g = d.value[f];
                e += '<button class="fr-color-bttn" data-val="' + g + '" data-cmd="' + d.cmd + '" style="background-color: ' + g + ';">&nbsp;</button>', f % 8 == 7 && f > 0 && (e += "<hr/>", (7 == f || 15 == f) && (e += '<div class="separator"></div>'))
            }
            e += "</div>", b += e
        }
        return b += "</div>"
        ...
        for (var c in a.seed) {
            var d = a.seed[c];
            b += '<li><button class="fr-bttn" data-cmd="' + d.cmd + '" title="' + d.title + '"><i class="' + d.icon + '"></i></button></li>'
        }
        return b += "</ul>"
    }, b.prototype.buildDropdownFontsize = function(a) {
        var b = '<ul class="fr-dropdown-menu f-font-sizes">';
        for (var c in a.seed)
        ...
        var c = '<ul class="fr-dropdown-menu">';
        for (var d in b.seed) {
            var e = b.seed[d];
            if (-1 != a.inArray(e.value, this.options.blockTags)) {
                var f = '<li data-cmd="' + b.cmd + '" data-val="' + e.value + '">';
                f += '<a href="#" data-text="true" class="format_' + e.value + '" title="' + e.title + '">' + e.title + "</a></li>", c += f
            }
        }
        return c += "</ul>"
    }, b.prototype.buildDropdownBlockStyle = function() {
        var a = '<ul class="fr-dropdown-menu fr-block-style">';
        return this.options.blockStylesToggle || (a += '<li data-cmd="blockStyle" data-val="*"><a href="#" data-text="true">Default</a></li>'), a += "</ul>"
        ...
        return b += "</ul>"
    }, b.prototype.mediaModalHTML = function() {
        ...
        this.$image_modal = a(this.mediaModalHTML()).appendTo("body"), this.$preloader = this.$image_modal.find("#f-preloader-" + this._id), this.$media_images = this.$image_modal.find("#f-image-list-" + this._id), this.$overlay = a('<div class="froala-overlay">').appendTo("body"), this.$image_modal.find("i#f-modal-close-" + this._id).click(a.proxy(function() {
            ...
            var d = a(c.currentTarget).prev(),
                e = "Are you sure? Image will be deleted.";
            b.LANGS[this.options.language] && (e = b.LANGS[this.options.language].translation[e]), confirm(e) && this.callback("beforeDeleteImage", [a(d)], !1) !== !1 && (a(d).parent().addClass("f-img-deleting"), this.deleteImage(a(d)))
        ...
        if (this.options.imageDeleteURL) {
            ...
            c.info = b.data("info"), a.post(this.options.imageDeleteURL, b.data("info"), a.proxy(function(a) {
                ...
                b.parent().removeClass("f-img-deleting"), this.callback("imageDeleteError", ["Missing imageDeleteURL option."], !1)
            }, this))
        } else b.parent().removeClass("f-img-deleting"), this.callback("imageDeleteError", ["Missing imageDeleteURL option."], !1)
    }, b.prototype.loadImage = function(c, d) {
        var e = new Image,
            f = a("<div>").addClass("f-empty");
        e.onload = a.proxy(function() {
            var e = "Delete";
            b.LANGS[this.options.language] && (e = b.LANGS[this.options.language].translation[e]);
            var g = a('<img src="' + c + '"/>');
            for (var h in d) g.attr("data-" + h, d[h]);
            f.append(g).append('<a class="f-delete-img"><span data-text="true">' + e + "</span></a>"), f.removeClass("f-empty"), this.$media_images.hide(), this.$media_images.show(), this.callback("imageLoaded", [c], !1)
        }, this), e.onerror = a.proxy(function() {
            f.remove(), this.throwImageError(1)
        }, this), e.src = c, this.$media_images.append(f)
        ...
        var c = this;
        this.$progress_bar = this.$image_wrapper.find("p#f-progress-" + this._id), this.options.imageUpload && (this.browser.msie && b.getIEversion() <= 9 && this.$image_wrapper.on("load", "iframe", function() {
            this.off("load"), this.$image_wrapper.on("load", "iframe", function() {
                try {
                    {
            ...
            if (void 0 !== this.files) c.uploadFile(this.files);
            else {
                ...
                b.submit(), c.$image_wrapper.find("#f-image-list-" + this._id).hide(), c.$progress_bar.show(), c.$progress_bar.find("span").css("width", "100%").text("Please wait!"), c.showInsertImage()
            }
        }), this.buildDragUpload()), this.$image_wrapper.on("mouseup touchend keydown", "#f-image-url-" + this._id, a.proxy(function(a) {
            a.stopPropagation()
        }, this));
        this.options.mediaManager && this.$image_wrapper.on("click", "#f-browser-" + this._id, a.proxy(function() {
    ...
    }, b.prototype.writeVideo = function(a, c) {
        if (c) d = a;
        else {
            var d = null;
            for (var e in b.VIDEO_PROVIDERS) {
                var f = b.VIDEO_PROVIDERS[e];
                if (f.test_regex.test(a)) {
                    a = a.replace(f.url_regex, f.url_text), d = f.html.replace(/\{url\}/, a);
                    break
                }
            }
        }
        d ? (this.$element.focus(), this.restoreSelection(), this.insertHTML(this.stripScript(d)), this.saveUndoStep(), this.$bttn_wrapper.show(), this.hideVideoWrapper(), this.hide(), this.callback("insertVideo", [d])) : this.callback("insertVideoError")
    }, b.prototype.insertVideoHTML = function() {
        var a = '<div class="video-wrapper" style="display: block;"><h4><span data-text="true">Insert video</span><i title="Cancel" class="fa fa-times" id="f-video-close-' + this._id + '"></i></h4><textarea placeholder="Embeded code" id="f-video-textarea-' + this._id + '"></textarea><p class="or">or</p><p><input placeholder="http://youtube.com/" id="f-video-input-' + this._id + '"/><button data-text="true" class="f-ok" id="f-video-ok-' + this._id + '">OK</button></p></div>';
        return a
    }, b.prototype.buildInsertVideo = function() {
        this.$video_wrapper = a(this.insertVideoHTML()), this.$popup_editor.append(this.$video_wrapper), this.$video_wrapper.on("mouseup touchend keydown", "input#f-video-input-" + this._id + ", textarea#f-video-textarea-" + this._id, a.proxy(function(a) {
            a.stopPropagation()
        }, this));
        var b = this;
    ...
    }, b.prototype.createLinkHTML = function() {
        var a = '<div class="link-wrapper">';
        if (a += '<h4><span data-text="true">Insert link</span><a target="_blank" title="Open Link" class="f-external-link" href="#"><i class="fa fa-external-link"></i></a><i title="Cancel" class="fa fa-times" id="f-link-close-' + this._id + '"></i></h4>', this.options.linkList.length && (a += '<input type="text" placeholder="Text" class="f-lt" id="f-lt-' + this._id + '">'), a += '<div class="f-input-wrapper"><input type="text" placeholder="http://www.example.com" class="f-lu" id="f-lu-' + this._id + '">', this.options.linkList.length) {
            ...
            for (var b in this.options.linkList) {
                var c = this.options.linkList[b];
                a += '<li class="f-choose-link" data-nofollow="' + c.nofollow + '" data-blank="' + c.blank + '" data-body="' + c.body + '" data-title="' + c.title + '" data-href="' + c.href + '">' + c.body + "</li>"
            }
            a += "</ul>"
        }
        return a += "</div>", a += '<p><input type="checkbox" id="f-checkbox-' + this._id + '"> <label data-text="true" for="f-checkbox-' + this._id + '">Open in new tab</label><button data-text="true" type="button" class="f-ok" id="f-ok-' + this._id + '">OK</button><button type="button" data-text="true" class="f-ok f-unlink" id="f-unlink-' + this._id + '">UNLINK</button></p></div>'
    }, b.prototype.buildCreateLink = function() {
        this.$link_wrapper = a(this.createLinkHTML()), this.$popup_editor.append(this.$link_wrapper);
        var b = this;
        this.isLink && this.$link_wrapper.on("mouseup touchend keydown", "input#f-lt-" + this._id, a.proxy(function(a) {
            a.stopPropagation(), this.$link_wrapper.trigger("hideLinkList")
        }, this)), this.$link_wrapper.on("mouseup touchend keydown", "input#f-lu-" + this._id, a.proxy(function(a) {
            a.stopPropagation(), this.$link_wrapper.trigger("hideLinkList")
            ...
            var c = (b.$link_wrapper.find("ul#f-link-list-" + b._id), b.$link_wrapper.find("button#f-browse-links-" + b._id)),
        ...
        }).on("mouseup touchend", "li.f-choose-link", function(a) {
            a.stopPropagation()
        ...
        }).on("mouseup touchend", "button#f-browse-links-" + this._id, function(a) {
            a.stopPropagation()
        }), this.$link_wrapper.bind("hideLinkList", function() {
            var a = b.$link_wrapper.find("ul#f-link-list-" + b._id);
            a && a.is(":visible") && $link_list_button.click()
        ...
        this.options.inlineMode && this.$bttn_wrapper.hide(), this.showLinkWrapper(), this.hideImageWrapper(!0), this.hideVideoWrapper(), this.$image_editor && this.$image_editor.hide(), this.link = !0
    }, b.prototype.showInsertImage = function() {
        this.options.inlineMode && this.$bttn_wrapper.hide(), this.hideLinkWrapper(), this.hideVideoWrapper(), this.showImageWrapper(), this.$image_editor && this.$image_editor.hide()
    }, b.prototype.showInsertVideo = function() {
        this.options.inlineMode && this.$bttn_wrapper.hide(), this.hideLinkWrapper(), this.hideImageWrapper(), this.showVideoWrapper(), this.$image_editor && this.$image_editor.hide()
    }, b.prototype.showImageEditor = function() {
        this.options.inlineMode && this.$bttn_wrapper.hide(), this.hideLinkWrapper(), this.hideImageWrapper(!0), this.hideVideoWrapper(), this.$image_editor && this.$image_editor.show(), this.options.imageMove || this.$element.attr("contenteditable", !1)
        ...
        void 0 === a && (a = !0), a ? this.hideOtherEditors() : (this.closeImageMode(), this.imageMode = !1), this.$popup_editor.hide(), this.hideLinkWrapper(), this.hideImageWrapper(), this.hideVideoWrapper(), this.$image_editor && this.$image_editor.hide(), this.link = !1
        ...
        var b = this;
        this.$bttn_wrapper.on("click touchend", ".fr-dropdown", function(c) {
            return c.stopPropagation(), c.preventDefault(), b.options.inlineMode === !1 && b.hide(), a(this).attr("data-disabled") ? !1 : (b.$bttn_wrapper.find(".fr-dropdown").not(this).removeClass("active"), void a(this).toggleClass("active"))
        ...
        var b = this;
        this.$bttn_wrapper.on("click touchend touchmove", "button[data-cmd], li[data-cmd]", a.proxy(function(c) {
            if ("touchmove" != c.type) {
                ...
                var e = a(d).data("cmd"),
                    f = a(d).data("val"),
                    g = a(d).data("param");
                a(d).parents(".fr-dropdown").removeClass("active"), b.exec(e, f, g), b.$bttn_wrapper.find(".fr-dropdown").removeClass("active")
            } else a(this).data("dragging", !0)
        }, this))
        ...
        return this.options.enableScript ? a : /^https?:\/\//.test(a) ? String(a).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : encodeURIComponent(a).replace("%23", "#").replace("%2F", "/").replace("%25", "%").replace("%3A", ":").replace("%40", "@")
        ...
        for (var g in e) {
            var h = a(e[g]);
            if (!this.fakeEmpty(h))
                if (f = "n" == b ? this.options.paragraphy ? a("<div>").html(h.html()) : h.html() + "<br/>" : a("<" + b + ">").html(h.html()), h.get(0) != this.$element.get(0) && "LI" != h.get(0).tagName) {
                    var i = h.prop("attributes");
                    if (f.attr)
                        for (var j in i) "class" !== i[j].name && f.attr(i[j].name, i[j].value);
                    var k = this.options.blockStyles[b];
                    void 0 === k && (k = this.options.defaultBlockStyle);
                    try {
                        if (h.hasClass(c)) f.addClass(h.attr("class")).removeClass(c);
                        else {
    ...
    }, b.prototype.blockStyle = function(a, b) {
        ...
        c.length > 0 ? this.$link_wrapper.find('input[type="checkbox"]').prop("checked", "_blank" == a(c[0]).attr("target")) : this.$link_wrapper.find('input[type="checkbox"]').prop("checked", this.options.alwaysBlank), this.$link_wrapper.find(".f-external-link").val(b || "#"), this.$link_wrapper.find('input[type="text"]').val(b || "http://")
        ...
        this.$bttn_wrapper.find(".fr-block-style").empty(), this.options.blockStylesToggle || this.$bttn_wrapper.find(".fr-block-style").append(a('<li data-cmd="blockStyle" data-val="*">').append(a('<a href="#" data-text="true">').text("Default")));
        ...
        if (!this.selectionInEditor() || this.isHTML) return !1;
        this.$bttn_wrapper.find('[data-cmd="formatBlock"]').each(a.proxy(function(a, b) {
            this.refreshFormatBlock(b)
        }, this));
        for (var c in this.options.buttons) {
            var d = this.options.buttons[c];
            void 0 != b.commands[d] && (void 0 != b.commands[d].disabled && b.commands[d].disabled.call(this) === !0 ? this.$editor.find('[data-name="' + d + '"]').attr("data-disabled", !0) : this.$editor.find('[data-name="' + d + '"]').removeAttr("data-disabled"))
        }
        this.refreshUndoRedo(), this.updateBlockStyles(), this.$bttn_wrapper.find("[data-cmd]").not('[data-cmd="formatBlock"]').each(a.proxy(function(b, c) {
            switch (a(c).data("cmd")) {
                case "fontSize":
        ...
        }, this)), 0 !== this.$bttn_wrapper.find(".fr-block-style .active").length || this.options.blockStylesToggle || this.$bttn_wrapper.find(".fr-block-style li:first").addClass("active")
